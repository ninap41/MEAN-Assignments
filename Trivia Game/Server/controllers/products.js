...
random: function (req,res){
    ...
    let random2 = Math.floor(Math.random() * num);
    let random3 = Math.floor(Math.random() * num);
    
    res.json({'random1': products[random], 'random2': products[random2], 'random3': products[random3]})
    })
